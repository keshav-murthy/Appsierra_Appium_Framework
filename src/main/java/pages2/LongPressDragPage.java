...
public class LongPressDragPage extends BasePage {
	...
	private static final Logger lOGGER = LogManager.getLogger(LongPressDragPage.class.getName());

	public LongPressDragPage(AppiumDriver driver) {
		super(driver);
	}
