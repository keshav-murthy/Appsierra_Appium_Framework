...
public class LoggerEventListener implements AppiumWebDriverEventListener, ITestListener, IAnnotationTransformer {
	...
	public void onTestStart(ITestResult result) {
		LOG.info("*******************" + result.getTestClass().getName() + "." + result.getMethod().getMethodName()
				+ " started*******************");
		try {
			MyScreenRecorder.startRecording(result.getTestClass().getName());
		} catch (Exception e) {
